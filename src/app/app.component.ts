...
@Component({
  selector: 'app-root',
  imports: [NavbarComponent,BannerComponent,Section1Component,Section2Component,Section3Component,Section4Component,Section5Component,
    Section6Component,Section7Component,Section8Component,FooterComponent],
